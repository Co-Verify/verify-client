...
app.get('/uploadDocument', (req, res) => {
    res.sendFile(path.join(__dirname + '/uploadDocument.html'));
})

app.get('/RequestForSignature', (req, res) => {
    res.sendFile(path.join(__dirname + '/RequestForSignature.html'));
})

app.get('/signDoc', (req, res) => {
    res.sendFile(path.join(__dirname + '/signDoc.html'));
})

app.get('/checkSignature', (req, res) => {
    res.sendFile(path.join(__dirname + '/checkSignature.html'));
})

app.get('/listRequest', (req, res) => {
    res.sendFile(path.join(__dirname + '/listRequest.html'));
})

app.get('/listOfRequest', (req, res) => {
    res.sendFile(path.join(__dirname + '/listOfRequest.html'));
})
...
app.post('/register', (req, res) => {
    ...
    ledgerAPI.invoke(channel, request).then((results) => {
